...
const Sidebar = ({
    ...
    const pathname = usePathname(); //Allows Dynamic Class Names
    return (
        ...
        bg-[#111827] text-white">
            <div className = "px-3 py-2 flex-1">
                <Link href = "/dashboard" className = "flex items-center pl-3 mb-14">
                    ...
                    <h1 className = {cn("text-2x1 font-bold", montserrat.className)}>
                        AIDE
                    </h1>
                </Link>
                <div className = "space-y-1">
                    {routes.map((route) => (
                        //Route is highlighted by default regardless of whether or not it is hovered over 
